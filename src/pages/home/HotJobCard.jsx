...
const HotJobCard = ({ job }) => {
  ...
  return (
    <motion.div
      ...
      className="border rounded-lg p-6 shadow-lg max-w-sm bg-white font-sans flex flex-col h-full"
    >
      {/* Content Wrapper */}
      ...
      <motion.button
        ...
        className="bg-blue-600 text-white font-semibold px-5 py-2 rounded-lg hover:bg-blue-700 focus:outline-none mt-auto"
